 ...
 * this.
 */
define([ "dojo/_base/declare", "dojo/dom-construct", "dojo/on", "../../util/_ReactiveTemplatedWidget", "./templates/BasicContentView.ejs" ], 
		  ...
		  displayContent: function(node, keys, newValue, oldValue, handle){
		    ...
		    if(newValue.hasContent){
		      ...
		      if(newValue.hasLargeContent) {
		        var button = domConstruct.place("<button>Load Content</button>",newValue,"only");
